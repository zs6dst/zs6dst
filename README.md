...
- Talking about certifications: I am a certified Project Manager. Never really used it professionally, but I've met PMs that could do with some certifications...
...
- I have been using mainly C# professionally for the last 15 years, writing backend services in the telecoms and banking industries. A large portion of this was to interface with external systems like SAP, web services and APIs.
...
- I had a brief flirt about 20 years ago attempting to write assembly programs for PIC chips. Since Arduino, my first love for assembly and embedded systems was rekindled. My FizzBuzz project combined my fascination of 7-segment displays, logic chips, C and steampunk electronics in a novel device. Creating the NightLamp project entirely in assembler was a blast from the past!
- I am also busy with cloud certifications. I want both the Azure and AWS Developer Associate certs.
- The pandemic was good to me - I will not go back to an office ever again. What management said could not be done, was done. Overnight. It works.
